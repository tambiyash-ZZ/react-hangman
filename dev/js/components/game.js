    ...
    render() {
        ...
        return (
            <div className="container">
                <div id="gamedesc" className="container">
                ...
                <div className="row" id="gamelayout" style={{ border: 'thin ridge', paddingBottom: '2em', marginTop: '3em' }}>
                    <div className="col-sm-12">
                        <div id="hints" style={{ paddingTop: '1em', paddingBottom: '10%' }}>
                            <div className="col-sm-3"><h5><strong><span className="text-default">Hint : </span></strong></h5></div>
                            <div className="col-sm-9"><h5><strong><span className="text-default">{this.props.word.hint_one}</span></strong></h5></div>
