...
const baseUrl = 'http://localhost:63243';
                    ...
                    (this.state.active ?
                        <div className="row">
                            <div id="gamesection" className="col-sm-12">
                                <StartUser ref='form' handleSubmit={this.handleFormSubmit.bind(this)} />
                            </div>
                        </div> :
                        <div className="row">
                            <div className="container">
                                <div id="gamesection" className="col-sm-8">
                                    <Game word={this.state.word} over={this.state.over} won={this.state.won} keyboardEnabled={!this.state.over && !this.state.won} guesses={this.state.guesses} onKeyBoardPress={this.checkLetter.bind(this)} classText={playing} turnsleft={this.state.strikes} onButtonClick={this.newGameUI.bind(this)} />
                                </div>
